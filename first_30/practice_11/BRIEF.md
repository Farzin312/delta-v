...
Sample f(t)=2t^2-3t+1 for t=-2..2 and identify where it rises or falls.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Functions, slope, intercept |
| Rust / Engineering | closures, function parameters, sampling |
