...
Integrate v(t)=2t from 0 to 3 using the trapezoid rule with dt=1. Interpret the result as displacement.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Riemann sums and trapezoids |
| Rust / Engineering | windows, iterators, numerical APIs |
