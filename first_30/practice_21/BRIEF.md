...
A 750 kg spacecraft receives 3 N thrust. Compute acceleration, then update velocity over 20 s under constant thrust.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Force, mass, acceleration |
| Rust / Engineering | data modeling, pure dynamics function |
