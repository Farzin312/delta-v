...
Build a CLI for x=x0+v0*t+0.5*a*t^2 and v=v0+a*t. Output CSV and test a known scenario.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Kinematic equations |
| Rust / Engineering | crate boundaries, CLI, CSV, integration tests |
