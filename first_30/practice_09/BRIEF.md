...
Implement a dot product that rejects vectors of different length. Compute [1,2,3] dot [4,-5,6].

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Projection and angle |
| Rust / Engineering | arrays, slices, iterators, zip |
