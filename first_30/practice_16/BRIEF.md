...
Implement Vec3 dot, cross, norm, and normalize. Verify x-hat cross y-hat = z-hat.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | 3-D vector algebra |
| Rust / Engineering | operator traits, normalization, robust errors |
