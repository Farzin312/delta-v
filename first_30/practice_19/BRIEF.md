...
Apply a 90-degree rotation then translation [10,0] to point [1,0]. Compare with translating then rotating.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Order matters |
| Rust / Engineering | matrix composition, API design |
