...
Package the spring or gravity simulator as a library + CLI. Include typed configuration, Euler and midpoint, CSV output, unit tests, property tests, a convergence report, README, and one architecture decision record.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Model + numerics + evidence |
| Rust / Engineering | workspace design, CI, documentation, release |
