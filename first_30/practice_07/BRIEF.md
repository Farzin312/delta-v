...
For constant velocity x(t)=x0+v*t with x0=10 m and v=2.5 m/s, produce samples from t=0 through 4 s.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Discrete samples of continuous motion |
| Rust / Engineering | for loops, ranges, Vec, iterators |
