...
Create an enum for Inertial, EarthFixed, and Body frames. Format a tagged vector and refuse unsupported transformations.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Coordinates require frames |
| Rust / Engineering | enums, match, exhaustive handling |
