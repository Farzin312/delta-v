...
A 10 N force acts at 60 degrees to a 5 m displacement. Compute work and reproduce it with vectors.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Dot product as alignment |
| Rust / Engineering | methods, semantic wrappers |
