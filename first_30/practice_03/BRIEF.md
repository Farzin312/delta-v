...
Redesign average speed so zero or negative elapsed time cannot silently return a misleading value.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Valid domains and inequalities |
| Rust / Engineering | Result, enums, pattern matching, ? operator |
