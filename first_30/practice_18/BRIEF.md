...
Implement a 2-D rotation matrix and rotate [1,0] by 90 degrees. Verify length preservation and inverse round-trip.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Matrices as transformations |
| Rust / Engineering | fixed arrays, matrix-vector multiplication |
