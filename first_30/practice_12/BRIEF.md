...
Estimate d/dt(t^2) at t=3 using forward and central differences for h=1, 0.1, and 0.01.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Difference quotient and error |
| Rust / Engineering | higher-order functions, validation, numerical experiment |
