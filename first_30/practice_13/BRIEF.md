...
Given equally spaced position samples, estimate interior velocity with central differences and explain why endpoints need a policy.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | First and second rates of change |
| Rust / Engineering | data windows, Option, boundary handling |
