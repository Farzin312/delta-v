...
Create distinct Meters and Seconds types and compute MetersPerSecond without allowing the caller to swap the two arguments.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Dimensional analysis |
| Rust / Engineering | tuple structs, impl, Copy, newtype pattern |
