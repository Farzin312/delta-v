...
Write tests that check gravity scaling (inverse-square), direction (toward origin), and energy conservation across a range of radii.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Structural properties as tests |
| Rust / Engineering | proptest concept, randomized cases |
