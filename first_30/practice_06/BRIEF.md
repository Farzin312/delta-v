...
Convert 30 degrees to radians and construct a unit direction vector. Explain why using 30 directly is wrong.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Angles, radians, sine, cosine |
| Rust / Engineering | associated functions, constants, constructors |
