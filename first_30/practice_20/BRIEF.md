...
Explain why 0.1+0.2 is not exactly 0.3 and implement a comparison using absolute plus relative tolerance.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Representation, absolute and relative error |
| Rust / Engineering | f64, epsilon, approximate comparison |
