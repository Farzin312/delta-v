...
Compute gravitational acceleration magnitude at geocentric radius 7000 km using mu=398600.4418 km^3/s^2 and return the vector toward the origin for r=[7000,0,0] km.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Universal gravitation and scale |
| Rust / Engineering | vector normalization, constants, singularities |
