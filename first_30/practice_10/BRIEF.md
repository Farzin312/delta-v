...
Split a motion program into a reusable library and a thin CLI. Document units and error behavior.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Separation of concerns |
| Rust / Engineering | modules, pub, lib.rs, main.rs, rustdoc, Git |
