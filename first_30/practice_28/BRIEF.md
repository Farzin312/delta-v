...
Integrate the spring over a fixed duration with dt, dt/2, dt/4. Compare endpoint error to a trusted small-step reference.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Global error and observed order |
| Rust / Engineering | experiment harnesses, CSV, log-log reasoning |
