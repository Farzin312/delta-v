...
A 200 N thruster fires for 20 s on a 1000 kg spacecraft. Compute impulse and ideal delta-v.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Impulse, momentum, delta-v |
| Rust / Engineering | state updates, sign conventions |
