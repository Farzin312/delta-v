...
Represent 1-D state y=[x,v] and derivative y'=[v,a]. Use a spring acceleration a=-k*x/m.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | ODE state-space form |
| Rust / Engineering | structs, traits, derivative APIs |
