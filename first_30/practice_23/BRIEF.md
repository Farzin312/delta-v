...
For a circular Earth orbit at r=7000 km, compute circular speed sqrt(mu/r) and specific orbital energy v^2/2-mu/r.

## What This Teaches

| Dimension | Focus |
|-----------|-------|
| Math / Physics | Kinetic and potential energy |
| Rust / Engineering | diagnostic functions, invariants |
